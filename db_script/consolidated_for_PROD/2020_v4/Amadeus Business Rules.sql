...
BEGIN TRY
		...
		DELETE FROM [ClientDefinedRuleBusinessEntity]   WHERE CreationUserIdentifier like '%Amadeus CA%'
...
VALUES
    ...
    ('PNR_CAR_SEGMENT_VENDOR_CODE', 'Reads the Car Segment Vendor Code from the PNR', @CreationTimeStamp, 'Amadeus CA Migration - US16315', 1, 1, 0),
    ('PNR_CAR_SEGMENT_TYPE', 'Reads the Car Segment Type from the PNR', @CreationTimeStamp, 'Amadeus CA Migration - US16315', 1, 1, 0),
    ...
    ('PNR_SEGMENT_TYPES_IN_PNR', 'Reads all the segment types in the PNR', @CreationTimeStamp, 'Amadeus CA Migration - US15240', 1, 1, 1),
    ('PNR_EB', 'Reads the PNR EB remark', @CreationTimeStamp, 'Amadeus CA Migration - US15240', 1, 0, 1),
    ('PNR_WRITE_REMARK_WITH_SEGMENT_RELATE', 'CA - Write remarks with segment relate', @CreationTimeStamp, 'Amadeus CA Migration - US15240', 1, 0, 1),
    ('PNR_DELETE_REMARK_THAT_CONTAINS', 'CA - Delete remarks that contains', @CreationTimeStamp, 'Amadeus CA Migration - US15240', 1, 0, 1),
    ('PNR_DP', 'Reads DP Remarks', @CreationTimeStamp, @CreationUserIdentifier, 1, 1, 1),
    ('PNR_AM_REMARKS_EXIST', '', @CreationTimeStamp, @CreationUserIdentifier, 1, 1, 1),
    ('PNR_REMARKS_APE', 'Reads APE Remarks', @CreationTimeStamp, @CreationUserIdentifier, 1, 1, 1),
    ('PNR_DELETE_AM_REMARKS', 'Deletes AM Remarks', @CreationTimeStamp, @CreationUserIdentifier, 1, 1, 1),
    ('PNR_DELETE_APE_REMARKS', 'Deletes APE Remarks', @CreationTimeStamp, @CreationUserIdentifier, 1, 1, 1),
    ('PNR_ADD_CRYPTIC_COMMAND', 'Execute cryptic command', @CreationTimeStamp, @CreationUserIdentifier, 1, 1, 1),
    ('PNR_ADD_REMARKS_FIRST_TST', 'Add Remarks 1st TST Only', @CreationTimeStamp, @CreationUserIdentifier, 1, 1, 1),
...
declare @CONTAINS as int
declare @NOTCONTAINS as int
DECLARE @CFA as varchar(15) = 'F3O|F1Y'
set @CreationUserIdentifier = 'CA Migration  ' + @CFA +  ' - US15250'
set @CDRGRoupName = 'Amadeus CA Migration - ' + @CFA +  ' Rule 1'
PRINT  @CDRGRoupName;
...
declare @CONTAINS as int
declare @NOTCONTAINS as int
DECLARE @CFA as varchar(25) = 'PVV|2FN|T3H|4MK|KN8'
set @CreationUserIdentifier = 'CA Migration  ' + @CFA +  ' - US15250'
set @CDRGRoupName = 'Amadeus CA Migration - ' + @CFA +  ' Rule 1'
PRINT 'START ' + @CDRGRoupName 
set @ClientSubUnitGuid = '14:3A7532'
