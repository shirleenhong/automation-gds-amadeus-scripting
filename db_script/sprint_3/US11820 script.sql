...
FROM [PNROutputGroup]
Where PNROutputGroupName = 'Canada Itinerary Remarks Group')
...
VALUES
	( '%CaSeatType%', '(([A-Z]{6}))', @CreationTimestamp, @CreationUserIdentifier, 1 ),
...
VALUES
	(@PNROutputItemID + 1, 1, 'S', 1, '', 'SEATING SUBJECT TO', @CreationTimestamp, @CreationUserIdentifier, 1, 'en-GB', NULL),
...
VALUES
	(@PNROutputItemID + 1, 'fr-CA', 'LE CHOIX DES SIEGES NE SE FAIT QU A L ENREGISTREMENT', @CreationTimestamp, @CreationUserIdentifier, 1),
	--/SX�
	...
	--/SX
	(@PNROutputItemID + 4, '(@PNROutputItemID + 5,'fr-CA','CHOIX DE SIEGE NON DISPONIBLE-%Cfr-CA','VERIFEZ DE NOUVEAU A LA BARRIERE',@CreationTimestamp,@CreationUserIdentifier,1), --/SX
												   aSeatType% SIEGE CONFIRME',@CreationTimestamp,@CreationUserIdentifier,1), --/SX
...
VALUES
	(@PNROutputItemId+1, 'CASeatRule', 'ONLINECHECKIN', @CreationTimeStamp, @CreationUserIdentifier, null, null, 1),
	...
	(@PNROutputItemId+11, 'CASeatRule', 'CLEARANCE', @CreationTimeStamp, @CreationUserIdentifier, null, null, 1)
		...
		SET @OutputRemarkGroupId = (SELECT MAX(PNROutputRemarkGroupId)
...
VALUES
	(@OutputRemarkGroupId + 1, 'CASeatRuleRemarks', @CreationTimeStamp, @CreationUserIdentifier, NULL, NULL, 1, NULL)		
