...
VALUES
	(@PNROutputItemID + 1, 1, 'S', 1, '', '%PassNameRedemption% PASS REDEMPTION-%FareType% FARE', @CreationTimestamp, @CreationUserIdentifier, 1, 'en-GB', NULL),
...
VALUES
	(@PNROutputItemID + 3, 'fr-CA', 'VOTRE NUMERO DE CONFIRMATION %AirlineCode% EST %ConfNbr%', @CreationTimestamp, @CreationUserIdentifier, 1)
