...
VALUES
	...
	( @CDRGRoupName, @bid3, '{"type":"text","label":"Destination","name":"destination","maxLength":"35","required":"true"}', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
    ...
    ( @CDRGRoupName, @bid4, 'RM* U12/-[UI_FORM_destination]', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
