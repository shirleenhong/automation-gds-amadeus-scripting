...
VALUES
    ...
    ( @CDRGRoupName, @bid3, '{ "type": "text", "label": "No Hotel Codes", "name": "noHotelCodes", "maxLength": "20", "required": "false" }', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
	...
	( @CDRGRoupName, @bid4, 'RM* U22/-[UI_FORM_splitCharge]', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
