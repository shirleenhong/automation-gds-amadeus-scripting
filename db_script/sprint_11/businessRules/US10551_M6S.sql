...
DECLARE @CFA as varchar(5) = 'M6S'

set @CreationUserIdentifier = 'Amadeus CA Migration  ' + @CFA +  ' - US10551'
...
SET @bidSegment=null; 
SELECT @bidSegment=ClientDefinedRuleBusinessEntityID
FROM ClientDefinedRuleBusinessEntity
...
BEGIN
    ...
    VALUES
        ...
        ( @CDRGRoupName, @bid, @NOTCONTAINS, 'HOTEL', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1);
...
VALUES
    ...
    ( @CDRGRoupName, @bid3, '{"type": "text","label": "Date","name": "arrivalDate","required": "false","maxlength" : "5","minlength" : "5","valuetype": "AlphaNumericMask"}', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
    ( @CDRGRoupName, @bid3, '{"type": "text","label": "City Code","name": "cityCode","required": "false","maxlength" : "3","minlength" : "3","valuetype": "AlphaMask"}', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
    ( @CDRGRoupName, @bid3, '{"type": "select","label": "Reason Code","name": "reasonCode","required": "false","options": [{"name": "Booked by customer at their lower rate","value": "CH"},{"name": "Booked by Local Office","value": "H3"},{"name": "Not staying at a hotel and will not seek reimbursement","value": "H7"},{"name": "Booked with meeting block or convention rate","value": "MH"},{"name": "Will modify this reservation later to add hotel","value": "TB"}]}', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
    ( @CDRGRoupName, @bid3, '{"type": "text","label": "Number of Days","name": "numberDays","required": "false","maxlength" : "2","minlength" : "2","valuetype": "NumberOnlyMask"}', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
    ( @CDRGRoupName, @bid4, 'RM* U21/-[UI_FORM_arrivalDate][UI_FORM_cityCode]H[UI_FORM_reasonCode][UI_FORM_numberDays]', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1),
    ( @CDRGRoupName, @bid4, 'RM* U22/-[UI_FORM_arrivalDate][UI_FORM_cityCode]H[UI_FORM_reasonCode][UI_FORM_numberDays]', @CreationTimestamp, @CreationUserIdentifier, @CreationTimestamp, @CreationUserIdentifier, 1)
