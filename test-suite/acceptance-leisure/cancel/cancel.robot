...
Verify That AC Segment Are Cancelled And Cancel Remarks Are Written
    ...
    Login To Amadeus Sell Connect
    Enter GDS Command    NM1Lastname/Firstname Mr    SS AC1074 Y 10NOV YYZCDG GK1 / 11551440 / ABCDEFG    SS AC1075 Y 13NOV CDGYYZ GK1 / 11551440 / ABCDEFG    SS AC1209 Y 15NOV YULDUB GK1 / 01301240 / 1234567   HU1AHK1STR15NOV-17NOV/GERMANY,PARK INN STUTTGART,TEL-+49 711320940,FAX-+49 7113209410,CF:12345,SINGLE ROOM,RATE:CWT EUR60.00/NIGHT,SI-*H01*/P1    SS AC1076 Y 20NOV YYZFRA GK1 / 11551440 / ABCDEFG    RU1AHK1SIN21NOV-/TYP-TOR/SUC-ZZ/SC-sin/SD-21NOV/ST-0900/EC-sin/ED-21NOV/ET-1800/PS-X
    ...    RM*CF/-RBM000000N    RM*NUC    APE-test@email.com
    Open CA Migration Window
    Click Wrap PNR
    Populate Reporting Required Fields
    Click Submit To PNR
...
Verify That RMX Cancel Remarks For AC And UA Are Written
    ...
    ...    RU1AHK1SIN21NOV-/TYP-TOR/SUC-ZZ/SC-sin/SD-21NOV/ST-0900/EC-sin/ED-21NOV/ET-1800/PS-X    RM*CF/-RBM000000N    RM*NUC    APE-test@email.com
    Open CA Migration Window
    Click Wrap PNR
    Populate Reporting Required Fields
    Click Submit To PNR
...
Verify That RMX Cancel Remarks Are Written For AC Cancel Check
    [Tags]    us12509
    Login To Amadeus Sell Connect
    Enter GDS Command    NM1Lastname/Firstname Mr    SS WS1234 Y 10NOV YYZYTO GK1 / 11551440 / ABCDEFG    SS AF1074 Y 15NOV YTOCDG GK1 / 11551440 / ABCDEFG    RM*CF/-RBM000000N    RM*NUC    APE-test@email.com
    Open CA Migration Window
    Click Wrap PNR
    Populate Reporting Required Fields
    Click Submit To PNR
