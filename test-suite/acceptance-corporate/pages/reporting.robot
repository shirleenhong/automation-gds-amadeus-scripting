...
Add Client Reporting Values For Multiple BSP Segment
    ...
    Enter Value    ${input_high_fare_3}    790.00
...
Verify That Client Reporting Remarks Are Written In The PNR For Single TST
    ...
    Get PNR Details
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FF/-1123.50/S2
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *LP/-300.00/S2
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FS/-L/S2
    Switch To Command Page
   
Verify That Client Reporting Remarks Are Written In The PNR For Multiple TSTs
    Switch To Graphic Mode
    Get PNR Details
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FF/-1123.50/S2-3
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *LP/-300.00/S2-3
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FS/-L/S2-3
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FF/-999.50/S4
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *LP/-123.00/S4
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FS/-L/S4
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FF/-790.00/S5
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *LP/-678.00/S5
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FS/-L/S5
    Switch To Command Page
...
Verify That Non-BSP Client Reporting Remarks Are Written In The PNR For Single Segment
    Switch To Graphic Mode
    Get PNR Details
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FF/-2101.00/S2
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *LP/-912.99/S2
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FS/-L/S2
    Switch To Command Page
...
Verify That Non-BSP Client Reporting Remarks Are Written In The PNR For Multiple Segments
    Switch To Graphic Mode
    Get PNR Details
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FF/-2101.00/S2-3
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *LP/-912.99/S2-3
    Run Keyword And Continue On Failure    Should Contain    ${pnr_details}    RM *FS/-L/S2-3
    Switch To Command Page
