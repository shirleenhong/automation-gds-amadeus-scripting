...
Where PNROutputGroupName = 'Canada Migration Itinerary Group')
		SET @PNROutputGroupID2 =	(SELECT PNROutputGroupId
FROM PNROutputGroup
...
VALUES
	(@PNROutputItemId + 1, 1, '0', 1, '', 'TRAIN NUMBER-%TrainNumber% CLASS-%TrainClassService%', @CreationTimestamp, @CreationUserIdentifier, 1, 'en-GB', NULL),
...
VALUES
	(@PNROutputItemId + 2, 'TrainVendorCode', 'vbk' , @CreationTimestamp, @CreationUserIdentifier, 1),
...
VALUES
	(@PNROutputGroupID2, @PNROutputItemId + 1, 0, @CreationTimestamp, @CreationUserIdentifier, 1, '1', '1'),
