...
export class TranslationService {
    ...
    remarkLines = [
        ['I DECLINED TO PURCHASE THE FOLLOWING TRAVEL INSURANCE', 'J AI REFUSE D ACHETER LES OPTIONS D ASSURANCES VOYAGES CI-DESSOUS'],
        ['OPTIONS THAT MY TRAVEL AGENT HAS OFFERED AND EXPLAINED TO ME', 'M AYANT ETE OFFERTES ET EXPLIQUEES PAR MON CONSEILLER EN VOYAGES'],
        ...
        ['ALL INCLUSIVE OR PREMIUM PROTECTION INSURANCE HAS BEEN PURCHASED.', 'LE FORFAIT D ASSURANCE SUPERIEUR A ETE ACHETE.'],
        ['FOR THE FULL VALUE OF THE TRIP.', 'RIR POUR LE MONTANT TOTAL DU VOYAGE.'],
        ['', ''],
        ['', ''],
