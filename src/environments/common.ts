export const common = {
  ...
  matchedPlacholderValueService: '/service/ap/remarks-manager/matched-placeholder-values',
  pnrAmadeusRequestService: '/service/ap/remarks-manager/pnr-amadeus-request',
